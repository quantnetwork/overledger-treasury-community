...
// Any amount above 50 will be taken as the escrowed deposit of the user (if a gateway then this is the staked amount)
const tokensToApprove = new BN(('52000000000000000000').toString(), 10); //52 QNT (with 18 decimal zeros)
